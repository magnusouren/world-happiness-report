export const Descriptions = () => (
  <ul>
    ...
    <li>
      <strong>Life Ladder score</strong>: The happiness score for each country,
      based on responses to the Cantril Ladder question that asks respondents to
      think of a ladder, with the best possible life for them being a 10, and
      the worst possible life being a 0.
    </li>
    <li>
    ...
    <li>
      <strong>Social support</strong>: The national average of binary responses
      (either 0 or 1 representing No/Yes) to the question about having relatives
      or friends to count on in times of trouble.
    </li>
    <li>
